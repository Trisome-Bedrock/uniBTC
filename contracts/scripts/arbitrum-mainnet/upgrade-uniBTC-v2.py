...
# `brownie run scripts/arbitrum-mainnet/upgrade-uniBTC-v2.py main "uniBTCMainnetDeployer" "uniBTCMainnetAdmin" --network=arbitrum-main -I`
...
def main(deployer="deployer", default_admin="default_admin", ):
    ...
    # Upgrade uniBTC
    frozen_users = ["0xe09b33096477e48223E260399Ee63B8CE6507a17"]
    ...
    print("Deployed uniBTC implementation: ", uniBTC_impl)  # 0x11b3808A5C0B612BC284EF7c2c6034C77A66BE7b

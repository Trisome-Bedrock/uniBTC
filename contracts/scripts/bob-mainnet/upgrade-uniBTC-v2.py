...
# `brownie run scripts/bob-mainnet/upgrade-uniBTC-v2.py main "uniBTCMainnetDeployer" "uniBTCMainnetAdmin" --network=bob-mainnet -I`
...
def main(deployer="deployer", default_admin="default_admin", ):
    ...
    # Upgrade uniBTC
    frozen_users = ["0x52Aa3e69E9dCb4b04237129040142A9CD2D7B300"]
